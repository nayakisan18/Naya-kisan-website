...
import frame4 from "../assets/frame-4@2x.png";
import clipPathGroup from "../assets/clip-path-group-1@2x.png";
import frame125 from "../assets/frame-125@2x.png";
import nayaKisan from "../assets/naya-kisan-1@2x.png";
...
const HomePage: FunctionComponent = () => {
  return (
    <div className="w-full relative bg-seagreen-200 overflow-hidden flex flex-col items-end justify-start pt-[50px] px-0 pb-0 box-border leading-[normal] tracking-[normal]">
      ...
      <section className="w-[1199px] flex flex-col items-end justify-start pt-0 pb-[214px] pl-5 pr-0 box-border gap-11 max-w-full text-left text-31xl text-khaki-100 font-poppins lg:pb-[139px] lg:box-border mq750:gap-[22px] mq750:pb-[90px] mq750:box-border">
        <VisionMissionContent />
        <div
          id="join-section"
          className="w-[956px] flex flex-col items-start justify-start gap-[84.6px] max-w-full mq750:gap-[21px] mq1050:gap-[42px]"
        >
      ...
      <Footer vector={vector2} socialIcon3={vector8} socialIcon6={vector11} />
    </div>
  );
};
